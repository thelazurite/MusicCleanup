...
namespace ATL.Logging
{
	...
	public class Log
	{
		...
		public const Int32 LV_DEBUG		= 0x00000008;
		public const Int32 LV_INFO		= 0x00000004;
		public const Int32 LV_WARNING		= 0x00000002;
		public const Int32 LV_ERROR		= 0x00000001;
		...
		public struct LogItem
		{
			...
			public Int32 Level;		// Logging level
        ...
        private IDictionary<Int32, String> locations;
		...
		public Log()
		{
            ...
            locations = new Dictionary<Int32, String>();
        ...
        public void Write(Int32 level, String msg)
        {
            write(level, msg, false);
        }

		private void write(Int32 level, String msg, Boolean forceDisplay)
		{
            // Creation and filling of the new LogItem
            var theItem = new LogItem();
        ...
        /// <param name="forceDisplay">If true, forces all registered ILogDevices to immediately log the message, even if asynchoronous logging is enabled</param>
        private void doWrite(LogItem theItem, Boolean forceDisplay)
        {
            ...
            else
            {
                ...
                foreach (var aLogger in logDevices)
                {
		...
		public IList<LogItem> GetAllItems(Int32 levelMask)
		{
            IList<LogItem> result = new List<LogItem>();

            lock (masterLog)
            {
                foreach (var anItem in masterLog)
                {
        ...
        public void FlushQueue()
        {
            lock (asyncQueue)
            {
                foreach (var item in asyncQueue)
                {
                    doWrite(item, true);
                }
                asyncQueue.Clear();

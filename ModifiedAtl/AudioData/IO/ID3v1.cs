...
namespace ATL.AudioData.IO
{
	...
	{
		public const Int32 MAX_MUSIC_GENRES = 148;        // Max. number of music genres
        public const Int32 DEFAULT_GENRE = 255;               // Index for default genre

        public const Int32 ID3V1_TAG_SIZE = 128;

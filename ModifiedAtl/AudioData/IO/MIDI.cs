...
namespace ATL.AudioData.IO
{
    ...
    public class Midi : MetaDataIO, IAudioDataIO
    {
        ...
        private Int32 timebase;           // timebase = ticks per frame (quarter note) a.k.a. PPQN (Pulses Per Quarter Note)
        private Int32 tempoMsgNum;        // position of tempo event in track 0

        private Int64 tempo;             // tempo (0 for unknown)
        ...
        {
            // Standard events
            public const Int32 EVT_PROGRAM_CHANGE = 0x0C;
            public const Int32 EVT_NOTE_ON = 0x09;
            public const Int32 EVT_NOTE_OFF = 0x08;
            public const Int32 EVT_POLY_PRESSURE = 0x0A;
            public const Int32 EVT_CONTROLLER_CHANGE = 0x0B;
            public const Int32 EVT_CHANNEL_PRESSURE = 0x0D;
            public const Int32 EVT_PITCH_BEND = 0x0E;
            public const Int32 EVT_META = 0xFF;
            public const Int32 EVT_SYSEX = 0xF0;

            // Meta events
            public const Int32 META_SEQUENCE_NUM = 0x00;
            public const Int32 META_TEXT = 0x01;
            public const Int32 META_COPYRIGHT = 0x02;
            public const Int32 META_TRACK_NAME = 0x03;
            public const Int32 META_INSTRUMENT_NAME = 0x04;
            public const Int32 META_LYRICS = 0x05;
            public const Int32 META_MARKER = 0x06;
            public const Int32 META_CUE = 0x07;
            public const Int32 META_CHANNEL_PREFIX = 0x20;
            public const Int32 META_CHANNEL_PREFIX_PORT = 0x21;
            public const Int32 META_TRACK_END = 0x2F;
            public const Int32 META_TEMPO = 0x51;
            public const Int32 META_SMPTE_OFFSET = 0x54;
            public const Int32 META_TIME_SIGNATURE = 0x58;
            public const Int32 META_KEY_SIGNATURE = 0x59;
            public const Int32 META_SEQUENCER_DATA = 0x7F; // Sequencer specific data
        }

        private class MidiEvent
        {
            public Int64 TickOffset = 0;
            public Int32 Type = 0;
            public Boolean isMetaEvent = false;
            public Int32 Channel = 0;

            public Int32 Param0 = 0;
            public Int32 Param1 = 0;
            public String Description;

            public MidiEvent(Int64 tickOffset, Int32 type, Int32 channel, Int32 param0, Int32 param1 = 0)
            {
        ...
        private class MidiTrack
        {
            ...
            public Int64 LastSignificantEventTicks = -1;
        ...
        private const Int32 DEFAULT_TEMPO = 500; // Default MIDI tempo is 120bpm, 500ms per beat
        ...
        public Int32 CodecFamily => AudioDataIoFactory.CfSeq;
        ...
        */
        ...
        private MidiTrack parseTrack(Byte[] data, Int32 trackNumber)
        {
            var track = new MidiTrack();

            var trackLen = data.Length;
                            ...
                            case 0xFF: // Meta
                                ...
                                switch (meta)
                                {
                                    ...
                                    case MidiEvents.META_CUE: // Meta Cue
                                        var texttypes = new String[7] { "Text", "Copyright", "TrkName", "InstrName", "Lyric", "Marker", "Cue" };

                                        var type = texttypes[meta - 1];
                                        position += 2;
                                    ...
                                    case MidiEvents.META_SMPTE_OFFSET: // SMPTE offset
                                        var h = data[position + 3];
                                        var m = data[position + 4];
                                        var s = data[position + 5];
                                        var f = data[position + 6];
                                        var fh = data[position + 7];
                                    ...
                                    case MidiEvents.META_TIME_SIGNATURE: // TimeSig
                                        var z = data[position + 3];
                                        var t = 2 ^ data[position + 4];
                                        var mc = data[position + 5];
                                        c = data[position + 6];
                                    ...
                                    default:
                                        ...
                                        position -= 3;
                                        {
                                            var str = Encoding.ASCII.GetString(data, position + 3, len); //sprintf("%02x",(byte)($data[$p+3+$i]));
                                            evt = new MidiEvent(currentTicks, meta, -1, currentTempo);
                                            evt.isMetaEvent = true;
        ...
        private Int32 readVarLen(ref Byte[] data, ref Int32 pos)
        {
            Int32 value;
            Int32 c;
